      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 p-5">
          ...
          <button
            type="button"
            onClick={copyUrl}
            className="w-full cursor-pointer rounded-xl bg-teal-600 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-teal-500 dark:bg-teal-500 dark:hover:bg-teal-400"
          >
